...
`{{AGENT_DIR}}/skills/blackhole/references/findings-ledger.md` § "Routing decision records"
for the `local_analyze` field shape; do not re-tabulate it here (`V-DRY-01`).

## Write protocol

Single-writer-orchestrator invariant
(`{{AGENT_DIR}}/skills/blackhole/references/blackhole-state.md` § Single-writer invariant):
...
full object (same shape as `{{AGENT_DIR}}/skills/blackhole/references/findings-ledger.md` §
