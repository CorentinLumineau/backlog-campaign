...
4.  **Gate**: status resolves per `{{AGENT_DIR}}/skills/blackhole/references/confidence-gates.md`'s
...
(`{{AGENT_DIR}}/skills/blackhole/references/artifact-contract.md`) is committed by
