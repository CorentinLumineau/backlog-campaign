...
- Skill: `plugins/blackhole/skills/blackhole/SKILL.md`
- Flow: `plugins/blackhole/skills/blackhole/references/multitask-mode.md`
...
Playbooks: `plugins/blackhole/skills/blackhole/references/phase-*.md`
