...
4.  **Gate**: status resolves per `.agents/build/skills/blackhole/references/confidence-gates.md`'s
...
(`.agents/build/skills/blackhole/references/artifact-contract.md`) is committed by
