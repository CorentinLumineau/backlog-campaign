...
Binding rules: `.cursor/rules/bc-campaign-vcodes.mdc`, `.cursor/skills/bc-campaign/references/review-core.md`.
...
1. **Reviewer output** — raw JSON from `bc-reviewer` (`status`, `findings[]`).
