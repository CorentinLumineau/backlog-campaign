...
Binding: `.cursor/skills/bc-campaign/SKILL.md`.
...
`.cursor/skills/bc-campaign/references/campaign-prompt.md` §
...
Worker return schemas: `.cursor/skills/bc-campaign/references/worker-schemas.md`.
