...
- Skill: `.claude/skills/bc-campaign/SKILL.md`
- Flow: `.claude/skills/bc-campaign/references/multitask-mode.md`
...
Playbooks: `.claude/skills/bc-campaign/references/phase-*.md`
