...
Binding: `{{AGENT_DIR}}/skills/bc-campaign/SKILL.md`.
...
`{{AGENT_DIR}}/skills/bc-campaign/references/campaign-prompt.md` §
...
Worker return schemas: `{{AGENT_DIR}}/skills/bc-campaign/references/worker-schemas.md`.
