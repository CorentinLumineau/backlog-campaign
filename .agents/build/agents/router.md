...
`.agents/build/skills/blackhole/references/queue-dag.md` § `route` object — that table is the
...
`.agents/build/skills/blackhole/references/findings-ledger.md` § "Routing decision records"
...
2. **`findings-ledger.json`** — append one `routing_decisions` row per
   `.agents/build/skills/blackhole/references/findings-ledger.md` § "Routing decision
